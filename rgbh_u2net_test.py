...
def save_output(image_name,pred,d_dir,i_test):
    ...
    Path(str(image_name).replace('rgb','auto_annotation_rgbh_overlay')).parents[0].mkdir(parents=True, exist_ok=True)
    cv2.imwrite(str(image_name).replace('rgb','auto_annotation_rgbh_overlay'),res)
    # image.save()
...
def main():
    ...
    model_dir = 'saved_models/rgbh_u2net/rgbh_u2net_s37072_2021-04-12_19_16_39/rgbh_u2net_37072_bce_itr_84000_train_0.167638_tar_0.019400.pth'
